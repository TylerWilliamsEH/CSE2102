...
public class Person extends HealthItem {
	...
	public Person(JSONObject jo) throws JSONException {
		...
		weight = new Weight();
		weight.setWeightValue("");
		weight.setKey("2");
		
		basicInfo = new DemographicInfo(null);
		basicInfo.setGender("");
		basicInfo.setKey("3");
	...
	public String toString() {
		//return "Person [firstName=" + firstName + ", lastName=" + lastName + ", birthDate=" + birthDate + ", bloodType=" + bloodType + ", race=" + race + ", key=" + key + "]"; 
