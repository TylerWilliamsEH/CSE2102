...
public class ServerConnectionHelper 
{
	...
	//private final static String SERVER_URL = "http://lab215-tartarus.engr.uconn.edu/Health";
	private final static String SERVER_URL = "http://cicats9.engr.uconn.edu:14080/Health";	
	...
	public static String serverRequestGet(String params)
	{
		...
		Log.e(VERB_TAG, SERVER_URL + params);	   	
